...
- ​Las inscripciones pueden ser realizadas por equipos de 1 y hasta máximo 4 participantes.

Se ofrecerán sesiones quincenales para ayudar a los equipos a familiarizarse con los datos de eventos y las visualizaciones comunes.

​Los datos proporcionados consisten en datos de eventos de todos los partidos de la Copa América 2024 y la Eurocopa 2024. Se pueden utilizar fuentes de datos externas siempre que sean de acceso público.

​No hay restricciones en cuanto a los lenguajes de programación o herramientas que los equipos deseen utilizar.

### ​Evaluación 📋

​La propuesta ganadora será seleccionada por un panel de jueces de todo el mundo. Son expertos de la industria con años de experiencia en el campo del análisis deportivo. Los jueces evaluarán cada propuesta en cinco categorías principales:
...
​Los 3 mejores proyectos tendrán la oportunidad de presentar su solución al público en el Networking Cocktail de la ITAM Sports Analytics Conference el 6 de noviembre de 2024, donde habrá numerosos profesionales de la industria y equipos presentes. El ganador se anunciará al día siguiente durante la conferencia.

​El ganador recibirá:

- ​La oportunidad de realizar una pasantía con nuestro equipo oficial asociado.

- ​Una licencia de un año para recursos de GCS.

- ​Entradas para el World Football Summit 2025.
...
Para aplicar:
1. Registra a tu equipo.
2. Envía un correo a *itamsportsanalytics@gmail.com* con el titulo **Requisicion de Mentor**.
